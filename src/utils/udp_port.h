static const char *get_udp_port(unsigned short port)
{
	switch (port) {
	case 0:
		return "Reserved";
	...
	case 270:
		return "Q-mode encapsulation for GIST messages";
	case 271:
		return "Reserved";
	case 280:
		return "http-mgmt";
	...
	case 398:
		return "Kryptolan";
	case 399:
		return "ISO Transport Class 2 Non-Control over UDP";
	case 400:
	...
	case 512:
		return "";
	case 513:
		return "maintains data bases showing who's logged in to machines on a local net and the load average of the machine";
	case 514:
		return "";
	case 515:
		return "spooler";
	...
	case 519:
		return "unixtime";
	case 520:
		return "local routing process (on site); uses variant of Xerox NS routing information protocol - RIP";
	case 521:
		return "ripng";
	case 522:
		return "ULP";
	...
	case 622:
		return "Collaborator";
	case 623:
		return "ASF Remote Management and Control Protocol";
	case 624:
		return "Crypto Admin";
	case 625:
	...
	case 663:
		return "PureNoise";
	case 664:
		return "ASF Secure Remote Management and Control Protocol";
	case 665:
		return "Sun DR";
	case 666:
		return "";
	...
	case 773:
		return "";
	case 774:
		return "IANA assigned this well-formed service name as a replacement for acmaint_dbd.";
	case 775:
		return "IANA assigned this well-formed service name as a replacement for acmaint_transd.";
	case 776:
		return "";
	case 777:
	...
	case 848:
		return "GDOI";
	case 853:
		return "DNS query-response protocol run over DTLS or QUIC";
	case 854:
	...
	case 861:
		return "OWAMP-Test";
	case 862:
		return "TWAMP-Test Receiver Port";
	case 873:
		return "rsync";
	case 886:
	...
	case 901:
		return "SMPNAMERES";
	case 902:
		return "self documenting Door: send 0x00 for info";
	case 903:
		return "self documenting Panic Door: send 0x00 for info";
	case 910:
	...
	case 914:
		return "Routing in Fat Trees Link Information Elements (TEMPORARY - registered 2023-02-17";
	case 915:
		return "Routing in Fat Trees Topology Information Elements (TEMPORARY - registered 2023-02-17";
	case 953:
		return "Reserved";
	case 989:
		return "ftp protocol";
	...
	case 994:
		return "Reserved";
	case 995:
		return "pop3 protocol over TLS/SSL (was spop3)";
	case 996:
		return "vsinet";
	case 997:
		return "";
	...
	case 1001:
		return "Reserved";
	case 1008:
		return "Possibly used by Sun Solaris????";
	case 1010:
		return "surf";
	case 1021:
	...
	case 2009:
		return "";
	case 2010:
		return "IANA assigned this well-formed service name as a replacement for pipe_server.";
	case 2011:
		return "";
	case 2012:
		return "";
	...
	case 2187:
		return "Sepehr System Management Data";
	case 2188:
		return "Reserved";
	case 2189:
		return "Reserved";
	...
	case 3487:
		return "LISA UDP Transfer Channel";
	case 3488:
	...
	case 4084:
		return "Fortisphere VM Service";
	case 4085:
		return "Reserved";
	case 4086:
		return "Firewall/NAT state table synchronization";
	case 4087:
		return "Reserved";
	case 4088:
		return "Reserved";
	...
	case 4169:
		return "Internet ADT Discovery Protocol";
	case 4170:
		return "Reserved";
	case 4171:
		return "Reserved";
	case 4172:
		return "PC over IP";
	case 4173:
		return "MMA Device Discovery";
	case 4174:
		return "StorMagic Discovery";
	case 4175:
		return "Reserved";
	case 4176:
		return "Reserved";
	...
	case 4190:
		return "Reserved";
	case 4191:
		return "Dual Stack MIPv6 NAT Traversal";
	case 4192:
		return "azeti blinddate";
	case 4193:
		return "Reserved";
	case 4194:
		return "Reserved";
	...
	case 4341:
		return "LISP Data Packets";
	case 4342:
		return "LISP Control Packets";
	case 4343:
		return "UNICALL";
	case 4344:
		return "VinaInstall";
	...
	case 4360:
		return "Reserved";
	case 4361:
		return "NavCom Discovery and Control Port";
	case 4362:
		return "AFORE vNode Discovery protocol";
	case 4366:
		return "ShadowStream System";
	case 4368:
	...
	case 4393:
		return "Reserved";
	case 4394:
		return "American Printware Discovery";
	case 4395:
	...
	case 4415:
		return "Reserved";
	case 4416:
		return "PJJ Media Player discovery";
	case 4417:
		return "Reserved";
	case 4418:
		return "AXYS communication protocol";
	case 4419:
		return "Reserved";
	case 4420:
	...
	case 4534:
		return "Armagetron Advanced Game Server";
	case 4535:
	...
	case 4555:
		return "RSIP Port";
	case 4556:
		return "DTN Bundle UDP CL Protocol";
	case 4557:
		return "Marathon everRun Quorum Service Server";
	case 4558:
		return "Marathon everRun Quorum Service Manager";
	case 4559:
		return "HylaFAX";
	case 4563:
		return "Reserved";
	...
	case 4606:
		return "Reserved";
	case 4621:
		return "Bidirectional single port remote radio VOIP and Control stream";
	case 4646:
	...
	case 4726:
		return "A26 (FAP-FGW)";
	case 4727:
		return "F-Link Client Information Service Discovery";
	case 4728:
		return "CA Port Multiplexer";
	case 4729:
		return "GSM Interface Tap";
	case 4730:
		return "Gearman Job Queue System";
	case 4731:
		return "Reserved";
	case 4732:
		return "OHM server trigger";
	case 4733:
		return "Reserved";
	case 4737:
		return "IPDR/SP";
	...
	case 4740:
		return "ipfix protocol over DTLS";
	case 4741:
		return "Luminizer Manager";
	case 4742:
		return "SICCT Service Discovery Protocol";
	case 4743:
	...
	case 4746:
		return "IntelliAdmin Discovery";
	case 4747:
		return "peer-to-peer file exchange protocol";
	case 4749:
	...
	case 4753:
		return "Simple Invocation of Methods Over Network (SIMON) Discovery";
	case 4754:
		return "GRE-in-UDP Encapsulation";
	case 4755:
		return "GRE-in-UDP Encapsulation with DTLS";
	case 4756:
		return "Reserved";
	case 4774:
		return "Reserved";
	...
	case 4785:
		return "Cisco Nexus Control Protocol";
	case 4786:
		return "Reserved";
	case 4787:
		return "Reserved";
	case 4788:
		return "Reserved";
	case 4789:
		return "Virtual eXtensible Local Area Network (VXLAN)";
	case 4790:
		return "Generic Protocol Extension for Virtual eXtensible Local Area Network (VXLAN)";
	case 4791:
		return "IP Routable RocE";
	case 4792:
	...
	case 4803:
		return "Notateit Messaging Discovery";
	case 4804:
		return "AJA ntv4 Video System Discovery";
	case 4827:
		return "HTCP";
	case 4837:
		return "Varadero-0";
	...
	case 4839:
		return "Varadero-2";
	case 4840:
		return "OPC UA Multicast Datagram Protocol";
	case 4841:
	...
	case 4878:
		return "Agilent Instrument Discovery";
	case 4879:
		return "Reserved";
	case 4880:
		return "Reserved";
	case 4881:
		return "SOCP Time Synchronization Protocol";
	case 4882:
		return "SOCP Control Protocol";
	case 4883:
		return "Reserved";
	case 4884:
	...
	case 4915:
		return "Reserved";
	case 4936:
		return "Signal protocol port for autonomic networking";
	case 4937:
		return "ATSC-M/H Service Signaling Channel";
	case 4940:
	...
	case 5013:
		return "FileMaker";
	case 5014:
		return "Overlay Network Protocol";
	case 5015:
		return "Reserved";
	case 5020:
		return "zenginkyo-1";
	...
	case 5030:
		return "Reserved";
	case 5031:
		return "Direct Message Protocol";
	case 5032:
		return "Reserved";
	case 5033:
		return "Reserved";
	...
	case 5045:
		return "Reserved";
	case 5046:
		return "Vishay PM UDP Service";
	case 5047:
		return "iSCAPE Data Broadcasting";
	case 5048:
		return "Reserved";
	case 5049:
	...
	case 5075:
		return "Reserved";
	case 5078:
		return "PixelPusher pixel data";
	case 5079:
		return "Cambridge Pixel SPx Reports";
	case 5080:
	...
	case 5104:
		return "TinyMessage";
	case 5105:
		return "Hughes Association Protocol";
	case 5106:
		return "Reserved";
	case 5107:
		return "Reserved";
	...
	case 5115:
		return "Reserved";
	case 5116:
		return "EPSON Projecter Image Transfer";
	case 5117:
		return "Reserved";
	case 5120:
	...
	case 5151:
		return "ESRI SDE Remote Start IANA assigned this well-formed service name as a replacement for esri_sde.";
	case 5152:
	...
	case 5163:
		return "Reserved";
	case 5164:
		return "Virtual Protocol Adapter Discovery";
	case 5165:
	...
	case 5243:
		return "Reserved";
	case 5245:
		return "DownTools Discovery Protocol";
	case 5246:
		return "CAPWAP Control Protocol";
	case 5247:
		return "CAPWAP Data Protocol";
	case 5248:
	...
	case 5271:
		return "StageSoft CueLink discovery";
	case 5272:
		return "PK";
	case 5280:
		return "Reserved";
	...
	case 5344:
		return "xkoto DRCP";
	case 5349:
		return "STUN over DTLS";
	case 5350:
		return "Port Control Protocol Multicast";
	case 5351:
	...
	case 5364:
		return "Microsoft Kernel Debugger";
	case 5397:
	...
	case 5445:
		return "Reserved";
	case 5450:
		return "TiePie engineering data acquisition (discovery)";
	case 5453:
		return "SureBox";
	case 5454:
		return "APC 5454";
	...
	case 5473:
		return "Reserved";
	case 5474:
		return "The Apsolab company's status query protocol";
	case 5475:
		return "Reserved";
	case 5500:
	...
	case 5666:
		return "Reserved";
	case 5670:
		return "Local area discovery and messaging over ZeroMQ";
	case 5671:
	...
	case 5682:
		return "BrightCore control & data transfer exchange";
	case 5683:
		return "Constrained Application Protocol";
	case 5684:
		return "DTLS-secured CoAP";
	case 5687:
		return "GOG multiplayer game protocol";
	case 5688:
	...
	case 5727:
		return "Reserved";
	case 5728:
		return "Dist. I/O Comm. Service Group Membership";
	case 5729:
	...
	case 5784:
		return "Cisco Interbox Application Redundancy";
	case 5785:
		return "3PAR Inform Remote Copy";
	case 5786:
		return "redundancy notification";
	case 5787:
		return "Cisco WAAS Cluster Protocol";
	case 5793:
		return "XtreamX Supervised Peer message";
	case 5794:
		return "Simple Peered Discovery Protocol";
	case 5798:
		return "Reserved";
	case 5813:
		return "ICMPD";
	...
	case 6077:
		return "Reserved";
	case 6080:
		return "Generic UDP Encapsulation";
	case 6081:
		return "Generic Network Virtualization Encapsulation (Geneve)";
	case 6082:
		return "APCO Project 25 Common Air Interface - UDP encapsulation";
	case 6083:
		return "telecomsoftware miami broadcast";
	case 6084:
		return "Reserved";
	case 6085:
	...
	case 6088:
		return "SuperDog License Manager Notifier";
	case 6099:
		return "Reserved";
	case 6100:
	...
	case 6117:
		return "Reserved";
	case 6118:
		return "Transparent Inter Process Communication";
	case 6121:
		return "Reserved";
	case 6122:
	...
	case 6159:
		return "Reserved";
	case 6160:
		return "Emerson Extensible Control and Management Protocol Data";
	case 6161:
	...
	case 6201:
		return "Management of service nodes in a processing grid for thermodynamic calculations";
	case 6209:
		return "QMTP over TLS";
	case 6222:
		return "Radmind Access Protocol";
	case 6241:
		return "JEOL Network Services Dynamic Discovery Protocol 1";
	case 6242:
		return "JEOL Network Services Dynamic Discovery Protocol 2";
	case 6243:
		return "JEOL Network Services Dynamic Discovery Protocol 3";
	case 6244:
		return "JEOL Network Services Dynamic Discovery Protocol 4";
	case 6251:
	...
	case 6315:
		return "Sensor Control Unit Protocol Discovery Protocol";
	case 6316:
		return "Ethernet Sensor Communications Protocol";
	case 6317:
		return "Navtech Radar Sensor Data";
	case 6320:
	...
	case 6324:
		return "HR Device Network service";
	case 6325:
		return "Reserved";
	case 6326:
		return "Reserved";
	...
	case 6418:
		return "Reserved";
	case 6419:
		return "Simple VDR Protocol Discovery";
	case 6420:
		return "NIM_VDRShell";
	case 6421:
		return "NIM_WAN";
	...
	case 6510:
		return "MCER Port";
	case 6511:
		return "Datagram Congestion Control Protocol Encapsulation for NAT Traversal";
	case 6513:
		return "Reserved";
	case 6514:
		return "syslog over DTLS";
	case 6515:
	...
	case 6568:
		return "Roaring Penguin IP Address Reputation Collection";
	case 6579:
		return "Affiliate";
	case 6580:
	...
	case 6632:
		return "Reserved";
	case 6633:
		return "Cisco vPath Services Overlay";
	case 6634:
		return "MPLS Performance Measurement out-of-band response";
	case 6635:
		return "Encapsulate MPLS packets in UDP tunnels.";
	case 6636:
		return "Encapsulate MPLS packets in UDP tunnels with DTLS.";
	case 6640:
		return "Reserved";
	case 6653:
		return "OpenFlow";
	...
	case 6678:
		return "Viscount Freedom Bridge Discovery";
	case 6679:
	...
	case 6690:
		return "Reserved";
	case 6696:
		return "Babel Routing Protocol";
	case 6697:
		return "Reserved";
	case 6699:
		return "Babel Routing Protocol over DTLS";
	case 6701:
	...
	case 6778:
		return "Reserved";
	case 6784:
		return "Bidirectional Forwarding Detection (BFD) on Link Aggregation Group (LAG) Interfaces";
	case 6785:
	...
	case 6970:
		return "Reserved";
	case 6980:
		return "QoS-extended OLSR protocol";
	case 6997:
	...
	case 7018:
		return "Reserved";
	case 7019:
		return "doceri drawing service screen view";
	case 7020:
		return "DP Serve";
	case 7021:
	...
	case 7031:
		return "Reserved";
	case 7040:
		return "Quest application level network service discovery";
	case 7070:
		return "ARCP";
	case 7071:
	...
	case 7088:
		return "Zixi live video transport protocol";
	case 7095:
		return "Java Discovery Protocol";
	case 7099:
		return "lazy-ptop";
	case 7100:
	...
	case 7174:
		return "Clutild";
	case 7181:
		return "Janus Guidewire Enterprise Discovery Service Bus";
	case 7200:
		return "FODMS FLIP";
	case 7201:
		return "DLIP";
	...
	case 7234:
		return "Reserved";
	case 7235:
		return "ASP Coordination Protocol";
	case 7236:
		return "Reserved";
	case 7237:
		return "Reserved";
	...
	case 7282:
		return "eventACTION/ussACTION (MZCA) alert";
	case 7283:
		return "Reserved";
	case 7365:
	...
	case 7420:
		return "Multichannel real-time lighting control";
	case 7421:
	...
	case 7550:
		return "Cloud Signaling Service";
	case 7551:
		return "Reserved";
	case 7560:
	...
	case 7574:
		return "Oracle Coherence Cluster discovery service";
	case 7588:
	...
	case 7781:
		return "accu-lmgr";
	case 7784:
		return "Seamless Bidirectional Forwarding Detection (S-BFD)";
	case 7786:
		return "MINIVEND";
	case 7787:
	...
	case 7802:
		return "Virtualized Network Services Tunnel Protocol";
	case 7810:
	...
	case 7871:
		return "Reserved";
	case 7872:
		return "TLS-based Mobile IPv6 Security";
	case 7878:
		return "Reserved";
	case 7880:
		return "Pearson";
	...
	case 7981:
		return "Reserved";
	case 7982:
		return "Spotlight on SQL Server Desktop Agent Discovery";
	case 7997:
		return "Reserved";
	case 7998:
		return "USI Content Push Service";
	case 7999:
		return "iRDMI2";
	case 8000:
		return "iRDMI";
	...
	case 8006:
		return "World Programming analytics discovery";
	case 8007:
	...
	case 8016:
		return "Reserved";
	case 8017:
		return "Cisco Cloudsec Dataplane Port Number";
	case 8019:
	...
	case 8059:
		return "Senomix Timesheets Client [1 year assignment]";
	case 8060:
		return "Asymmetric Extended Route Optimization (AERO)";
	case 8061:
		return "Reserved";
	case 8066:
		return "Reserved";
	...
	case 8102:
		return "Reserved";
	case 8111:
		return "Skynetflow network services";
	case 8115:
	...
	case 8149:
		return "Edge of Reality game data";
	case 8153:
		return "Reserved";
	case 8160:
		return "Patrol";
	...
	case 8201:
		return "TRIVNET";
	case 8202:
		return "Audio+Ethernet Standard Open Protocol";
	case 8204:
		return "LM Perfworks";
	case 8205:
		return "LM Instmgr";
	...
	case 8211:
		return "Aruba Networks AP management";
	case 8230:
		return "RexecJ Server";
	case 8231:
		return "HNCP";
	case 8232:
		return "HNCP over DTLS";
	case 8243:
		return "Synapse Non Blocking HTTPS";
	case 8266:
		return "ESPeasy peer-2-peer communication";
	case 8270:
		return "Reserved";
	case 8276:
	...
	case 8282:
		return "Libelle EnterpriseBus discovery";
	case 8292:
	...
	case 8383:
		return "M2m Services";
	case 8384:
		return "Marathon Transport Protocol";
	case 8400:
		return "cvd";
	case 8401:
		return "sabarsd";
	...
	case 8432:
		return "Reserved";
	case 8433:
		return "Non Persistent Desktop and Application Streaming";
	case 8442:
	...
	case 8444:
		return "PCsync HTTP";
	case 8445:
		return "Port for copy discovery";
	case 8448:
		return "Reserved";
	case 8450:
		return "npmp";
	...
	case 8501:
		return "CYTEL Message Transfer Audio and Video";
	case 8502:
		return "Reserved";
	case 8503:
		return "MPLS LSP Self-Ping";
	case 8554:
	...
	case 8609:
		return "Canon Compact Printer Protocol Discovery";
	case 8610:
	...
	case 8668:
		return "Reserved";
	case 8675:
		return "Motorola Solutions Customer Programming Software for Radio Management Discovery";
	case 8686:
	...
	case 8804:
		return "truecm";
	case 8805:
		return "Destination Port number for PFCP";
	case 8807:
		return "HES-CLIP Interoperability protocol";
	case 8808:
		return "STATSports Broadcast Service";
	case 8809:
		return "MCPTT Off-Network Protocol (MONP)";
	case 8873:
	...
	case 8883:
		return "Secure MQTT";
	case 8888:
		return "NewsEDGE server UDP (UDP 1)";
	case 8889:
		return "NewsEDGE server broadcast";
	case 8890:
		return "NewsEDGE client broadcast";
	case 8891:
		return "Desktop Data UDP 3: NESS application";
	case 8892:
		return "Desktop Data UDP 4: FARM product";
	case 8893:
		return "Desktop Data UDP 5: NewsEDGE/Web application";
	case 8894:
		return "Desktop Data UDP 6: COAL application";
	case 8899:
		return "ospf-lite";
	case 8900:
		return "JMB-CDS 1";
	...
	case 8981:
		return "Network of Devices Client";
	case 8989:
	...
	case 9005:
		return "Reserved";
	case 9007:
		return "Open Grid Services Client";
	case 9008:
		return "Reserved";
	case 9009:
	...
	case 9010:
		return "Reserved";
	case 9011:
		return "D-Star Routing digital voice+data for amateur radio";
	case 9020:
		return "TAMBORA";
	case 9021:
	...
	case 9051:
		return "Reserved";
	case 9060:
		return "CardWeb realtime device data";
	case 9080:
		return "Groove GLRPC";
	case 9081:
		return "Required for Adaptive Quality of Service";
	case 9083:
		return "Reserved";
	case 9084:
	...
	case 9106:
		return "Astergate Discovery Service";
	case 9107:
		return "Reserved";
	case 9111:
	...
	case 9277:
		return "GPS Data transmitted from train to ground network";
	case 9278:
	...
	case 9631:
		return "Reserved";
	case 9632:
		return "Mobile-C Communications";
	case 9640:
		return "Reserved";
	case 9666:
		return "Reserved";
	...
	case 9877:
		return "Reserved";
	case 9878:
		return "The KX509 Kerberized Certificate Issuance Protocol in Use in 2012";
	case 9888:
	...
	case 9898:
		return "MonkeyCom";
	case 9899:
		return "SCTP TUNNELING";
	case 9900:
		return "IUA";
	case 9901:
		return "enrp server channel";
	case 9903:
		return "Multicast Ping Protocol";
	case 9909:
		return "domaintime";
	case 9911:
	...
	case 9954:
		return "Reserved";
	case 9955:
		return "Contact Port for AllJoyn multiplexed constrained messaging";
	case 9956:
		return "Alljoyn Name Service";
	case 9966:
	...
	case 10020:
		return "Reserved";
	case 10023:
		return "Comtech EF-Data's Vipersat Management Protocol";
	case 10050:
		return "Zabbix Agent";
	case 10051:
	...
	case 10111:
		return "NMEA OneNet multicast messaging";
	case 10113:
	...
	case 10161:
		return "SNMP-DTLS";
	case 10162:
		return "SNMP-Trap-DTLS";
	case 10200:
		return "Trigence AE Soap Service";
	case 10201:
		return "Remote Server Control and Test Service";
	case 10252:
		return "Apollo Relay Port";
	case 10253:
		return "Relay of EAPOL frames";
	case 10260:
	...
	case 10321:
		return "Reserved";
	case 10439:
		return "BalanceNG session table synchronization protocol";
	case 10443:
		return "Reserved";
	case 10500:
		return "HIP NAT-Traversal";
	case 10540:
	...
	case 10809:
		return "Reserved";
	case 10810:
		return "Nuance Mobile Care Discovery";
	case 10860:
	...
	case 11108:
		return "Hardware Terminals Discovery and Low-Level Communication Protocol";
	case 11109:
		return "Reserved";
	case 11110:
		return "Reserved";
	...
	case 11171:
		return "Surgical Notes Security Service Discovery (SNSS)";
	case 11172:
		return "Reserved";
	case 11173:
		return "Reserved";
	...
	case 11430:
		return "Lenbrook Service Discovery Protocol";
	case 11489:
		return "Reserved";
	case 11600:
	...
	case 11751:
		return "Intrepid SSL";
	case 11796:
		return "Lanschool Multipoint";
	case 11876:
		return "X2E Xoraya Multichannel protocol";
	case 11877:
		return "X2E service discovery protocol";
	case 11967:
	...
	case 13218:
		return "EMV Virtual CAS Service Discovery";
	case 13223:
		return "PowWow Client";
	case 13224:
		return "PowWow Server";
	case 13400:
		return "DoIP Discovery";
	case 13720:
	...
	case 14001:
		return "De-Registered";
	case 14002:
		return "Discovery of a SCOTTY hardware codec board";
	case 14033:
	...
	case 15002:
		return "Reserved";
	case 15118:
		return "v2g Supply Equipment Communication Controller Discovery Protocol";
	case 15345:
	...
	case 15998:
		return "2ping Bi-Directional Ping Service";
	case 15999:
		return "Reserved";
	case 16000:
		return "Reserved";
	...
	case 16002:
		return "Reserved";
	case 16003:
		return "Automation and Control by REGULACE.ORG";
	case 16020:
		return "Reserved";
	case 16021:
		return "Reserved";
	...
	case 17222:
		return "Control Plane Synchronization Protocol (SPSP)";
	case 17223:
		return "Reserved";
	case 17224:
		return "Train Realtime Data Protocol (TRDP) Process Data";
	case 17225:
	...
	case 17500:
		return "Dropbox LanSync Discovery";
	case 17555:
		return "Reserved";
	case 17729:
	...
	case 18463:
		return "AC Cluster";
	case 18516:
		return "HeyThings Device communicate service";
	case 18634:
	...
	case 19220:
		return "Discovery for Client Connection Management and Data Exchange Service";
	case 19283:
	...
	case 19541:
		return "JCP Client";
	case 19788:
		return "Mesh Link Establishment";
	case 19790:
		return "Reserved";
	case 19998:
		return "Reserved";
	...
	case 20012:
		return "Samsung Interdevice Interaction discovery";
	case 20013:
		return "Reserved";
	case 20014:
	...
	case 22335:
		return "Initium Labs Security and Automation Streaming";
	case 22343:
	...
	case 22537:
		return "Reserved";
	case 22555:
		return "Vocaltec Internet Phone";
	case 22763:
	...
	case 23053:
		return "Reserved";
	case 23272:
		return "S102 application";
	case 23294:
		return "5AFE SDN Directory discovery";
	case 23333:
	...
	case 24322:
		return "Transport of Human Interface Device data streams";
	case 24323:
		return "Reserved";
	case 24386:
	...
	case 24754:
		return "Reserved";
	case 24850:
		return "Device Association Discovery";
	case 24922:
	...
	case 25903:
		return "NIProbe";
	case 25954:
		return "Bitfighter game server";
	case 25955:
		return "Bitfighter master server";
	case 26000:
		return "quake";
	case 26133:
	...
	case 27876:
		return "Reserved";
	case 27999:
		return "Attribute Certificate Services";
	case 28000:
	...
	case 28080:
		return "Reserved";
	case 28119:
		return "A27 cdma2000 RAN Management";
	case 28200:
	...
	case 30400:
		return "Reserved";
	case 30832:
		return "Samsung Convergence Discovery Protocol";
	case 30999:
		return "OpenView Service Desk Client";
	case 31016:
		return "Kollective Agent Kollective Delivery Protocol";
	case 31020:
		return "Reserved";
	case 31029:
		return "YaWN - Yet Another Windows Notifier";
	case 31337:
	...
	case 33333:
		return "Reserved";
	case 33334:
		return "SpeedTrace TraceAgent Discovery";
	case 33434:
		return "traceroute use";
	case 33435:
		return "IP Multicast Traceroute";
	case 33656:
		return "SNIP Slave";
	case 33890:
		return "Reserved";
	...
	case 35354:
		return "Reserved";
	case 35355:
		return "Altova License Management Discovery";
	case 35356:
		return "Reserved";
	case 35357:
		return "Reserved";
	...
	case 36411:
		return "Wireless LAN Control plane Protocol (WLCP)";
	case 36412:
		return "Reserved";
	case 36422:
		return "Reserved";
	...
	case 38001:
		return "Reserved";
	case 38002:
		return "Cresco Controller Discovery";
	case 38201:
	...
	case 40000:
		return "SafetyNET p";
	case 40023:
		return "K-PatentsSensorInformation";
	case 40404:
		return "Reserved";
	case 40841:
		return "CSCP";
	...
	case 40843:
		return "CSCCFIREWALL";
	case 40853:
		return "ORTEC Service Discovery";
	case 41111:
		return "Foursticks QoS Protocol";
	case 41121:
		return "Reserved";
	case 41230:
		return "Z-Wave Protocol over DTLS";
	case 41794:
	...
	case 42999:
		return "Reserved";
	case 43000:
		return "Receiver Remote Control Discovery";
	case 43188:
		return "REACHOUT";
	case 43189:
	...
	case 43191:
		return "Reserved";
	case 43210:
		return "Shaper Automation Server Management Discovery";
	case 43438:
		return "HmIP LAN Routing";
	case 43439:
		return "EQ3 discovery and configuration";
	case 43440:
		return "Cisco EnergyWise Discovery and Command Flooding";
	case 43441:
	...
	case 44445:
		return "Reserved";
	case 44544:
		return "DOMIQ Building Automation";
	case 44553:
	...
	case 44900:
		return "M3DA Discovery is used for efficient machine-to-machine communications";
	case 45000:
		return "Nuance AutoStore Status Monitoring Protocol (device monitoring)";
	case 45001:
		return "Reserved";
	case 45002:
		return "Reserved";
	...
	case 45054:
		return "InVision AG";
	case 45514:
		return "ASSIA CloudCheck WiFi Management keepalive";
	case 45678:
		return "EBA PRISE";
	case 45824:
		return "Reserved";
	...
	case 47001:
		return "Reserved";
	case 47100:
		return "Configuration of motors connected to Industrial Ethernet";
	case 47557:
	...
	case 47809:
		return "PreSonus Universal Control Network Protocol";
	case 48000:
	...
	case 49000:
		return "Reserved";
	case 49001:
		return "Nuance Unity Service Discovery Protocol";
	case 49150:
		return "Reserved";
	default:
